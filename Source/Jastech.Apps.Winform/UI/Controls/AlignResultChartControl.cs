...
{
    public partial class AlignResultChartControl : UserControl
    {
        ...
        public AlignResultChartControl()
        {
            InitializeComponent();
        }

        private void AlignResultChartControl_Load(object sender, EventArgs e)
        {
            AddControl();
        ...
        private void AddControl()
        {
            ...
            pnlAlignResultChart.Controls.Add(ResultChartControl);
        }
